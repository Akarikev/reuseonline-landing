import Codeblock from "@/components/ProductHunt";
...
export default function Home() {
  return (
    <>
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              and{" "}
              <code className="bg-red-600 p-1 rounded-md text-white">
                offline
              </code>{" "}
      ...
      <div className="mx-auto flex justify-center p-6 backdrop-blur-0 bg-gray-500/10">
        <div className="flex-col">
          <p className="font-semibold">made by prince elorm with 💖</p>
          <p className="font-semibold">@ princeelorm17@gmail.com</p>
        </div>
      </div>
    </>
  );
